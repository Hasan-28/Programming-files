...
def intro():
    ...
    name = input()
    print(name + " we are going to play a game. I am thinking of a number between 1 and 30")
    time.sleep(.5)
...
def pick():
    ...
    while guessesTaken < 6:  # if the number of guesses is less than 6
        ...
        try:  # check if a number was entered
            ...
            if guess <= 30 and guess >= 1:  # if they are in range
            ...
            if guess > 30 or guess < 1:  # if they aren't in the range
